        ...
        (i.prototype.load = function (t) {
          function r() {
            i.$recycle(this.url, s),
              a(),
              c.indexOf("firefox") >= 0 && (s.pause(), (s.muted = !1)),
              (o.loaded = !0),
              ...
              function (r) {
                ...
                if (
                  ...
                  n._setBitmapData(t.posterData),
                    t.$nativeDisplayObject.setBitmapData(n);
                }
              },
              this
            ),
    ...
    var r = (function (t) {
      ...
      return (
        ...
        (r.prototype._initElement = function () {
          ...
          for (var o = this.$textfield, s = 1, c = 1, l = 0; o.parent; )
            (s *= o.scaleX), (c *= o.scaleY), (l += o.rotation), (o = o.parent);
          var h = e.web.getPrefixStyleName("transform");
          (this.inputDiv.style[h] = "rotate(" + l + "deg)"),
            (this._gscaleX = n * s),
            (this._gscaleY = a * c);
        }),
...
!(function (e) {
  ...
  !(function (e) {
    ...
    (e.CanvasRenderBuffer = r),
      __reflect(r.prototype, "egret.web.CanvasRenderBuffer", [
      ...
      return (
        ...
        (r.prototype.getLocation = function (t) {
          ...
          return (
            90 == this.rotation
              ? ((s = c), (l = i.width - o))
              : -90 == this.rotation && ((s = i.height - c), (l = o)),
            (s /= this.scaleX),
            (l /= this.scaleY),
            e.$TempPoint.setTo(Math.round(s), Math.round(l))
          );
        }),
    ...
    e.WebLifeCycleHandler = function (e) {
      ...
      if (((s || a) && (o = !1), o)) {
        ...
        (c.execWebFn = c.execWebFn || {}),
          (c.execWebFn.postX5GamePlayerMessage = function (t) {
            var r = t.type;
      ...
      return (
        ...
        (i.$init = function () {
          ...
          (c == n.WEB_AUDIO && a) || c == n.HTML5_AUDIO
            ? ((s = !1), i.setAudioType(c))
            : ((s = !0), i.setAudioType(n.HTML5_AUDIO)),
            r.indexOf("android") >= 0
              ? s && a && i.setAudioType(n.WEB_AUDIO)
              : (r.indexOf("iphone") >= 0 ||
                  r.indexOf("ipad") >= 0 ||
                  r.indexOf("ipod") >= 0) &&
                i.getIOSVersion() >= 7 &&
                ((i._canUseBlob = !0), s && a && i.setAudioType(n.WEB_AUDIO));
    ...
    var r = (function (r) {
      ...
      return (
        ...
        (i.prototype.init = function (r, i) {
          ...
          (n.showFPS || n.showLog) &&
            (e.nativeRender ||
              l.displayFPS(n.showFPS, n.showLog, n.logFilter, n.fpsStyles)),
            (this.playerOption = n),
            (this.container = r),
            (this.canvas = s),
            (this.stage = a),
        ...
        (i.prototype.updateScreenSize = function () {
          ...
          if (!t.userTyping) {
            ...
            if (0 != a && 0 != o) {
              ...
              c != e.OrientationMode.AUTO &&
                (s =
                  (c != e.OrientationMode.PORTRAIT && o > a) ||
                  (c == e.OrientationMode.PORTRAIT && a > o));
              var l = s ? o : a,
                h = s ? a : o;
              (e.Capabilities.boundingClientWidth = l),
              ...
              e.Matrix.release(w),
                ...
                this.webTouchHandler.updateScaleMode(y, x, g),
    ...
    var t = (function () {
      ...
      return (
        ...
        (e.prototype.cacheArrays = function (
          ...
          if (
            ((0 != T || 0 != S) &&
              ((w = T * y + S * m + w), (E = T * x + S * b + E)),
            !d)
          ) {
            (0 != a || 0 != o) &&
              ((w = a * y + o * m + w), (E = a * x + o * b + E));
            var _ = s / i;
            1 != _ && ((y = _ * y), (x = _ * x));
            var C = c / n;
            1 != C && ((m = C * m), (b = C * b));
          ...
          if (d) {
            ...
            for (D = 0, A = u.length; A > D; D += 2)
              ($ = L + (5 * D) / 2),
                ...
                (R[$ + 4] = v);
            if (this.hasMesh)
              for (var P = 0, W = f.length; W > P; ++P)
                this.indicesForMesh[this.indexIndex + P] =
                  f[P] + this.vertexIndex;
            ...
            if (this.hasMesh) {
              ...
              (U[this.indexIndex + 0] = 0 + this.vertexIndex),
                (U[this.indexIndex + 1] = 1 + this.vertexIndex),
                (U[this.indexIndex + 2] = 2 + this.vertexIndex),
                (U[this.indexIndex + 3] = 0 + this.vertexIndex),
                (U[this.indexIndex + 4] = 2 + this.vertexIndex),
                (U[this.indexIndex + 5] = 3 + this.vertexIndex);
            }
      ...
      return (
        ...
        (i.prototype.getWebGLTexture = function (e) {
          return (
            e.webGLTexture ||
              ...
              e.webGLTexture && (e.webGLTexture.smoothing = !0)),
            e.webGLTexture
          );
        }),
        ...
        (i.prototype.drawMesh = function (
          ...
          if (!this.contextLost && e && y) {
            var x, m, b;
            if (e.texture || (e.source && e.source.texture))
              (x = e.texture || e.source.texture),
                y.saveTransform(),
                (m = y.$offsetX),
                (b = y.$offsetY),
                y.useOffset(),
                y.transform(1, 0, 0, -1, 0, c + 2 * o);
            else {
              if (!e.source && !e.webGLTexture) return;
            ...
            x &&
              ...
              (e.texture || (e.source && e.source.texture)) &&
                ((y.$offsetX = m), (y.$offsetY = b), y.restoreTransform()));
          }
        }),
        (i.prototype.drawTexture = function (
          ...
          if (!this.contextLost && e && y) {
            ...
            this.drawCmdManager.pushDrawTexture(e, x, this.$filter, l, h),
              this.vao.cacheArrays(y, t, r, i, n, a, o, s, c, l, h, u, d, f, v);
          }
        }),
        ...
        (i.prototype.pushMask = function (e, t, r, i) {
          ...
          !this.contextLost &&
            n &&
            (n.$stencilList.push({ x: e, y: t, width: r, height: i }),
            this.vao.reachMaxSize() && this.$drawWebGL(),
          ...
          if (e) {
            ...
            switch (e.type) {
              case 0:
                a
                  ? "custom" === a.type
                    ? (i = t.EgretWebGLProgram.getProgram(
                        n,
                        a.$vertexSrc,
                        a.$fragmentSrc,
                        a.$shaderKey
                      ))
                    : "colorTransform" === a.type
                    ? (i = t.EgretWebGLProgram.getProgram(
                        n,
              ...
              case 8:
                ...
                s &&
                  (s.rootRenderTarget && s.rootRenderTarget.enabledStencil(),
        ...
        (i.prototype.syncUniforms = function (e, t, r, i) {
          ...
          for (var a in n)
            if ("projectionVector" === a)
              n[a].setValue({ x: this.projectionX, y: this.projectionY });
            else if ("uTextureSize" === a) n[a].setValue({ x: r, y: i });
            else if ("uSampler" === a);
            else {
              var o = t.$uniforms[a];
        ...
        (i.prototype.drawTargetWidthFilters = function (e, r) {
          ...
          if (a > 1)
            for (var o = 0; a - 1 > o; o++) {
              ...
              (i = t.WebGLRenderBuffer.create(c, l)),
      ...
      a = (function () {
        ...
        return (
          (a.prototype.render = function (t, r, i, a) {
            ...
            if (
              (i.$invertInto(l),
              o.transform(l.a, l.b, l.c, l.d, 0, 0),
              e.Matrix.release(l),
              this.nestLevel--,
              0 === this.nestLevel)
            ) {
          ...
          (a.prototype.drawDisplayObject = function (t, r, i, n, a) {
            ...
            if (
              (c && !a
                ? ((t.$cacheDirty ||
                    t.$renderDirty ||
                    c.$canvasScaleX != e.sys.DisplayList.$canvasScaleX ||
                    c.$canvasScaleY != e.sys.DisplayList.$canvasScaleY) &&
                    (s += c.drawToSurface()),
                  (o = c.$renderNode))
          ...
          (a.prototype.drawWithFilter = function (t, a, o, s) {
            ...
            if (
              ...
              if (!t.$children || 1 == y)
                return (
                  u && a.context.setGlobalCompositeOperation(l),
            ...
            if (
              (x.context.pushBuffer(x),
              (c += t.$mask
                ? this.drawWithClip(t, x, -f, -p)
                : t.$scrollRect || t.$maskRect
                ? this.drawWithScrollRect(t, x, -f, -p)
                : this.drawDisplayObject(t, x, -f, -p)),
              x.context.popBuffer(),
              c > 0)
            ) {
              u && a.context.setGlobalCompositeOperation(l),
              ...
              (m.a = b.a),
                ...
                (m.ty = b.ty),
                a.useOffset(),
                a.context.drawTargetWidthFilters(h, x),
                (b.a = m.a),
                (b.b = m.b),
                (b.c = m.c),
                (b.d = m.d),
          ...
          (a.prototype.drawWithClip = function (t, a, o, s) {
            ...
            if (d || (t.$children && 0 != t.$children.length)) {
              ...
              if (
                ...
                (l += this.drawDisplayObject(t, m, -v, -g)),
                d)
              ) {
                ...
                w.copyFrom(d.$getConcatenatedMatrix()),
                  ...
                  e.Matrix.release(w),
                  (l += this.drawDisplayObject(d, b, 0, 0)),
                  b.context.popBuffer(),
              ...
              if (
                ...
                l++,
                  h && a.context.setGlobalCompositeOperation(c),
                ...
                (S.a = _.a),
                  ...
                  (S.tx = _.tx),
                  (S.ty = _.ty),
                  _.append(1, 0, 0, -1, o + v, s + g + m.height);
            ...
            return (
              u && a.context.pushMask(u.x + o, u.y + s, u.width, u.height),
              h && a.context.setGlobalCompositeOperation(c),
              (l += this.drawDisplayObject(t, a, o, s)),
              h && a.context.setGlobalCompositeOperation(i),
              u && a.context.popMask(),
              l
            );
          ...
          (a.prototype.renderGraphics = function (r, i, n) {
            ...
            if (!(0 >= a || 0 >= o) && a && o && 0 != r.drawData.length) {
              ...
              (1 > a * s || 1 > o * c) && (s = c = 1),
                (r.$canvasScaleX != s || r.$canvasScaleY != c) &&
                  ((r.$canvasScaleX = s),
                  (r.$canvasScaleY = c),
                  (r.dirtyRender = !0)),
                (a *= s),
              ...
              if (
                ...
                (o = h),
                this.canvasRenderBuffer && this.canvasRenderBuffer.context
                  ? (r.dirtyRender || n) && this.canvasRenderBuffer.resize(a, o)
                  : ((this.canvasRenderer = new e.CanvasRenderer()),
